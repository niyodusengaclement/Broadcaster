...
dbRoutes.patch('/red-flags/:red_Flag_Id/comment', auth.userAuthentication, auth.grantAccess, report.editComment);
dbRoutes.patch('/red-flags/:red_Flag_Id/location', auth.userAuthentication, auth.grantAccess, report.changeLocation);
dbRoutes.patch('/red-flags/:red_Flag_Id/status', auth.userAuthentication, auth.isAdmin, report.changeStatus);
dbRoutes.delete('/red-flags/:red_Flag_Id', auth.userAuthentication, auth.grantAccess, report.deleteRecord);
